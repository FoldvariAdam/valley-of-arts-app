...
class _TicketsApiClient implements TicketsApiClient {
  _TicketsApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://jegyek.muveszetekvolgye.hu/api';
  }
  ...
  @override
  Future<ProductsResponse> getProducts(String language) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'l': language};
