...
class PopularProgramsCarousel extends StatefulWidget {
  final List<Program> programs;

  const PopularProgramsCarousel({super.key, required this.programs});

  @override
  State<PopularProgramsCarousel> createState() =>
      _PopularProgramsCarouselState();
}

class _PopularProgramsCarouselState extends State<PopularProgramsCarousel> {
...
class _PopularCard extends StatelessWidget {
  ...
  const _PopularCard({required this.program, required this.isActive});
        ...
        child: ClipRRect(
          ...
          child: GestureDetector(
            ...
            child: Stack(
              fit: StackFit.expand,
              children: [
                CachedProgramImage(imageUrl: program.displayUrl),
