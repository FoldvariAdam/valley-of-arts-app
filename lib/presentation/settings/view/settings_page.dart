            ...
            Entrance(
              ...
              child: AppCard(
                child: SingleSelectList<String>(
                  ...
                  onSelected: (val) => setState(() => selectedLanguage = val),
                  itemBuilder: (val, isSelected, index, length) {
                    switch (val) {
                      case 'hu':
                        return SelectableRow(
                          leading: Text('🇭🇺', style: appTheme.mediumHeadLine),
            ...
            Entrance(
              ...
              child: AppCard(
                child: Column(
                  children: [
                    LabeledSwitch(
                      title: LocaleKeys.Settings_General_Position_Title.tr(),
                      subtitle:
                          LocaleKeys.Settings_General_Position_Subtitle.tr(),
                    ...
                    LabeledSwitch(
                      title:
                          LocaleKeys.Settings_General_Notifications_Title.tr(),
                      subtitle: LocaleKeys
            ...
            Entrance(
              ...
              child: AppCard(
                child: Column(
                  children: [
                    LabeledSwitch(
                      title: LocaleKeys.Settings_SnailBus_Tracking_Title.tr(),
                      subtitle:
                          LocaleKeys.Settings_SnailBus_Tracking_SubTitle.tr(),
                      value: snailBusTracking,
                      onChanged: (v) => setState(() => snailBusTracking = v),
                    ),
